  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        ...
        <input required id="email" type="email" name="email" className="h-11 w-full border border-line bg-white px-3 text-sm focus:border-ink focus:outline-none" placeholder="admin@dgem.org" />
      </div>
      <div>
        <label className="mb-1.5 block text-[10px] font-bold uppercase tracking-widest text-mutefg" htmlFor="password">
          Password
        </label>
        <input required id="password" type="password" name="password" className="h-11 w-full border border-line bg-white px-3 text-sm focus:border-ink focus:outline-none" />
      </div>
